...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/start-azstackhcivmvirtualmachineinstance
schema: 2.0.0
---

# Start-AzStackHciVMVirtualMachineInstance
...
### Start (Default)
```
Start-AzStackHciVMVirtualMachineInstance -ResourceUri <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzStackHciVMVirtualMachineInstance -InputObject <IStackHciVMIdentity> [-DefaultProfile <PSObject>]
