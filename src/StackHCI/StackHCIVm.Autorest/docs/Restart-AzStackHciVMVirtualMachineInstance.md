...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/restart-azstackhcivmvirtualmachineinstance
schema: 2.0.0
---

# Restart-AzStackHciVMVirtualMachineInstance
...
### Restart (Default)
```
Restart-AzStackHciVMVirtualMachineInstance -ResourceUri <String> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-AzStackHciVMVirtualMachineInstance -InputObject <IStackHciVMIdentity> [-DefaultProfile <PSObject>]
