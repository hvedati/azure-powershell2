...
```
Remove-AzStackHciVMVirtualHardDisk -ResourceId <String> [-InputObject <IStackHciVMIdentity>]
...
### ByName
```
Remove-AzStackHciVMVirtualHardDisk -Name <String> -ResourceGroupName <String>
