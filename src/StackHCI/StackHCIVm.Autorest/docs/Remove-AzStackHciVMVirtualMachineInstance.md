...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/remove-azstackhcivmvirtualmachineinstance
schema: 2.0.0
---

# Remove-AzStackHciVMVirtualMachineInstance
...
### Delete (Default)
```
Remove-AzStackHciVMVirtualMachineInstance -ResourceUri <String> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzStackHciVMVirtualMachineInstance -InputObject <IStackHciVMIdentity> [-DefaultProfile <PSObject>]
