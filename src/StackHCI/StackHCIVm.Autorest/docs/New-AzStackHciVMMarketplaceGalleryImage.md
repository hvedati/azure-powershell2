...
New-AzStackHciVMMarketplaceGalleryImage -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-HyperVGeneration <HyperVGeneration>] [-Offer <String>] [-OSType <OperatingSystemTypes>]
 [-Publisher <String>] [-Sku <String>] [-SystemDataCreatedAt <DateTime>] [-SystemDataCreatedBy <String>]
