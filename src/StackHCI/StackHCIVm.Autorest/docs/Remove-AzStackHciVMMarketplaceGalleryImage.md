...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/remove-azstackhcivmmarketplacegalleryimage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzStackHciVMMarketplaceGalleryImage -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzStackHciVMMarketplaceGalleryImage -InputObject <IStackHciVMIdentity> [-DefaultProfile <PSObject>]
