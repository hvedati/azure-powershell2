...
online version: https://learn.microsoft.com/powershell/module/az.stackhcivm/stop-azstackhcivmvirtualmachineinstance
schema: 2.0.0
---

# Stop-AzStackHciVMVirtualMachineInstance
...
### Stop (Default)
```
Stop-AzStackHciVMVirtualMachineInstance -ResourceUri <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzStackHciVMVirtualMachineInstance -InputObject <IStackHciVMIdentity> [-DefaultProfile <PSObject>]
